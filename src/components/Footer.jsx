...
const Footer = () => {
  return (
    ...
    <div className="w-1/2 h-full flex flex-col justify-between font-['NeueMontreal'] ">
        <div className="heading">
        <h1 className="text-[7vw] font-semibold uppercase leading-none -mb-10">Eye-</h1>
        <h1 className="text-[5vw] font-semibold uppercase leading-none -mb-10 p-2 m-3">Opening</h1>
        </div>
    ...
    <div className="w-1/2">
    <h1 className="text-[5.5vw] font-semibold  font-['NeueMontreal'] uppercase leading-none -mb-10">PRESENTATIONS </h1>
    <div className="detalis font-['NeueMontreal']  mt-10">
    <h1 className="font-['NeueMontreal'] font-semibold mt-10 underline">S:</h1>
        ...
        <h1 className="font-['NeueMontreal'] font-semibold mt-10 underline">M:</h1>
        ...
        <h1 className="font-['NeueMontreal'] font-semibold mt-10 underline">G:</h1>
        <a className="block text-xl font-light text-zinc-300" href="#">Saurabh6386@gmail.com</a>
        <h3>saurabh yadav</h3>
